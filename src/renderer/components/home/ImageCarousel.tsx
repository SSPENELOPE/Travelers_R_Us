    ...
    <Carousel className="carousel-container">
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p>
            Click <a href="https://www.nps.gov/grsm/index.htm">here</a> to learn
            more and plan your stay!
          </p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p style={{ color: '#222222', fontWeight: 'bold' }}>
            Where Peaks Pierce the Sky, click{' '}
            <a
              style={{ color: 'yellow' }}
